<?php
    ...
    function add_status(){
        ...
        if(isset($_POST['add_status'])){
            ...
            $add_sta=$con->prepare("INSERT INTO deliverstatus(deli_id,cart_id, user_id, user_name, condi, img, status, deli_date)
                                    VALUES('$deli_id','$cart_id', '$user_id', '$user_name', '$condi', '$img', '$status', NOW())");
