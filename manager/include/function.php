        ...
        if(isset($_GET['edit_pro'])){
            ...
            if(isset($_POST['edit_product'])){
                ...
                $edit_pro=$con->prepare("UPDATE products SET pro_name='$pro_name', cat_id='$cat_id',
                                        pro_img1='$pro_img1', pro_img2='$pro_img2', pro_weight='$pro_weight', pro_description='$pro_description',
                                        pro_moredescription='$pro_moredescription', pro_price='$pro_price', pro_keyword='$pro_keyword' WHERE pro_id='$pro_id'");
